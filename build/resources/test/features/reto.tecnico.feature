...
Feature: Technical Challenge
  ...
  Scenario Outline: Search for a automation course
    ...
    Examples:
      ...
      | josefer       | Moncada      |memoncaditapp@hotmail.com  |August  |2       |2002    |Spanish    |Bogota D.C|250240      |Samsung      |A900         |BlackBerry 4.2.2 |Colombianos87. |Colombianos87.      |memoncaditapp@hotmail.com |Colombianos87.|